Public Class Matriks
    ...
    Private Sub btn_proses_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_proses.Click
        ...
        End Try
    End Sub
    Private Sub copyToArray(ByVal baris1 As Integer, ByVal baris2 As Integer, ByVal kolom1 As Integer, ByVal kolom2 As Integer, ByRef nilai1(,) As Integer, ByRef nilai2(,) As Integer)
        If (Me.cekKolom) Then
        ...
        End If
    End Sub
    Private Sub cek(ByVal baris1 As Integer, ByVal baris2 As Integer, ByVal kolom1 As Integer, ByVal kolom2 As Integer)
    ...
    Private Sub operasi(ByVal matriks1(,) As Integer, ByVal matriks2(,) As Integer, ByVal batasBaris As Integer, ByVal batasKolom As Integer)
        Dim hasil As String = ""
        If (Me.cekKolom) Then
